package com.example.examagenda.adaptadores;
...
import com.example.examagenda.VerActivity;
...
public class ListaContactosAdapter extends RecyclerView.Adapter<ListaContactosAdapter.ContactoViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ContactoViewHolder holder, int position) {
        ...
        holder.viewInfo.setText(listaContactos.get(position).getInformacion_trabajo());
    ...
    public class ContactoViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView viewNombre, viewInfo, viewTelefono, viewCorreo;
